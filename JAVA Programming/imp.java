...
class tuna extends JFrame
{
	...
	private JPanel p1,p2,p3,p4,p5,main,tp;
	private JScrollPane pane,tpan;
	private JSplitPane span;
	...
	public tuna()
	{
		...
		span = new JSplitPane(JSplitPane.VERTICAL_SPLIT,pane,tp);
		add(span);
